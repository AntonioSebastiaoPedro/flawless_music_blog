...
<!-- Mirrored from milo.bootlab.io/post-video.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Jun 2021 22:30:34 GMT -->
  ...
  <header>
    <nav class="navbar navbar-expand-md navbar-light bg-white absolute-top">
      <div class="container">
        ...
        <a class="navbar-brand mx-auto order-1 order-md-3" href="index-2.html">Milø</a>
        ...
        <div class="col-md-9">
          ...
          <article class="card mb-4">
            <header class="card-header text-center">
              <div class="card-meta">
                <a href="#"><time class="timeago" datetime="2019-10-21 20:00">21 october 2019</time></a> in <a href="page-category.html">Journey</a>
              </div>
              <a href="post-image.html">
                <h1 class="card-title">The king is made of paper</h1>
              </a>
            </header>
            <a href="post-image.html">
              <div class="vimeo">
                <iframe src="https://player.vimeo.com/video/203710832?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
              </div>
            </a>
            <div class="card-body">
              ...
              <div class="media mb-3">
                ...
                <div class="media-body">
                  ...
                  <time class="timeago text-muted" datetime="2019-12-03 20:00">3 december 2019</time>
                  ...
                  <div class="media mt-3">
                    ...
                    <div class="media-body">
                      ...
                      <time class="timeago text-muted" datetime="2019-12-14 19:00">14 december 2019</time>
                      <a class="float-right" href="#"><span class="fa fa-reply"></span> Reply</a>
                    </div>
                  </div>
                </div>
              ...
              <div class="media mb-3">
                ...
                <div class="media-body">
                  ...
                  <time class="timeago text-muted" datetime="2019-11-20 20:00">20 november 2019</time>
                  <a class="float-right" href="#"><span class="fa fa-reply"></span> Reply</a>
                </div>
              </div>
              ...
              <div class="media mb-3">
                ...
                <div class="media-body">
                  ...
                  <time class="timeago text-muted" datetime="2019-11-05 20:00">5 november 2019</time>
                  <a class="float-right" href="#"><span class="fa fa-reply"></span> Reply</a>
                </div>
              </div>
